...
class Scaler:
    ...
    def inv_scale_output(self, y, origional_x):
        ...
        # cloud water を元に戻す
        water_ratio = origional_x[:, 120:180] / (
            origional_x[:, 120:180] + origional_x[:, 180:240] + self.eps
        )
        ice_ratio = origional_x[:, 180:240] / (
            origional_x[:, 120:180] + origional_x[:, 180:240] + self.eps
        )
        y[:, 120:180] = y[:, 120:180] * water_ratio
        y[:, 180:240] = y[:, 180:240] * ice_ratio
        return y
