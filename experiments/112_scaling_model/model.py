# https://github.com/pytorch/examples/blob/main/distributed/tensor_parallelism/llama2_model.py
...
if __name__ == "__main__":
    ...
    in_channels = 60
    n_dim = 1024
    model_args = ModelArgs(dim=n_dim, n_layers=4, n_heads=8)
    print(model_args)
