...
class CustomLoss(nn.Module):
    def __init__(self, cfg, device="cuda"):
        ...
        self.mae_rate = cfg.exp.loss.mae_rate
    ...
    def forward(self, output, target, mask):
        loss = self.mse_loss(
            output[mask][:, self.use_cols_index], target[mask][:, self.use_cols_index]
        )

        loss += self.mae_rate * self.mae_loss(
