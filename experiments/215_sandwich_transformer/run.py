...
class TransformerEncoderBlock(nn.Module):
    def __init__(self, n_dim, nhead, num_layers, dim_feedforward=2048, dropout=0.0):
...
class LeapModel(nn.Module):
    def __init__(
        ...
        self.transformer_encoder_in = TransformerEncoderBlock(
            in_channels,
            t_nhead,
            t_num_layers,
    ...
    def forward(self, x, x_cat):
        ...
        x = self.transformer_encoder_in(x)
