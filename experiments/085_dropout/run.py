...
class MLP(nn.Module):
    def __init__(self, in_size, hidden_sizes, dropout=0.2):
...
class LeapModel(nn.Module):
    def __init__(
        ...
        self.same_height_encoder = MLP(
            previous_size, same_height_hidden_sizes, dropout=dropout
        )
        ...
        self.t_head = MLP(
            8 + n_base_channels, same_height_hidden_sizes + [1], dropout=dropout
        )
        self.q_head = MLP(
            9 + n_base_channels, same_height_hidden_sizes + [3], dropout=dropout
        )
