...
class Scaler:
    ...
    def process_features(self, x_array):
        ...
        for window_size in [3, 5, 7]:
            if f"t_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                t_diff_mean_array = rolling_mean(t_diff_array, window_size)
                feats.append(t_diff_mean_array)
            if f"q1_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                q1_diff_mean_array = rolling_mean(q1_diff_array, window_size)
                feats.append(q1_diff_mean_array)
            if f"q2_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                q2_diff_mean_array = rolling_mean(q2_diff_array, window_size)
                feats.append(q2_diff_mean_array)
            if f"q3_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                q3_diff_mean_array = rolling_mean(q3_diff_array, window_size)
                feats.append(q3_diff_mean_array)
            if f"u_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                u_diff_mean_array = rolling_mean(u_diff_array, window_size)
                feats.append(u_diff_mean_array)
            if f"v_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                v_diff_mean_array = rolling_mean(v_diff_array, window_size)
                feats.append(v_diff_mean_array)
            if f"ozone_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                ozone_diff_mean_array = rolling_mean(ozone_diff_array, window_size)
                feats.append(ozone_diff_mean_array)
            if f"ch4_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                ch4_diff_mean_array = rolling_mean(ch4_diff_array, window_size)
                feats.append(ch4_diff_mean_array)
            if f"n2o_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                n2o_diff_mean_array = rolling_mean(n2o_diff_array, window_size)
                feats.append(n2o_diff_mean_array)
            if f"q2q3_mean_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                q2q3_mean_diff_mean_array = rolling_mean(
                    q2q3_mean_diff_array, window_size
                )
                feats.append(q2q3_mean_diff_mean_array)
            if f"uv_mean_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                uv_mean_diff_mean_array = rolling_mean(uv_mean_diff_array, window_size)
                feats.append(uv_mean_diff_mean_array)
            if f"pbuf_mean_diff_mean_{window_size}" in self.cfg.exp.seq_feats:
                pbuf_mean_diff_mean_array = rolling_mean(
                    pbuf_mean_diff_array, window_size
                )
                feats.append(pbuf_mean_diff_mean_array)
            # std
            if f"t_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                t_diff_mean_array, t_diff_std_array = rolling_mean_std(
                    t_diff_array, window_size
                )
                feats.append(t_diff_std_array)
            if f"q1_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                q1_diff_mean_array, q1_diff_std_array = rolling_mean_std(
                    q1_diff_array, window_size
                )
                feats.append(q1_diff_std_array)
            if f"q2_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                q2_diff_mean_array, q2_diff_std_array = rolling_mean_std(
                    q2_diff_array, window_size
                )
                feats.append(q2_diff_std_array)
            if f"q3_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                q3_diff_mean_array, q3_diff_std_array = rolling_mean_std(
                    q3_diff_array, window_size
                )
                feats.append(q3_diff_std_array)
            if f"u_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                u_diff_mean_array, u_diff_std_array = rolling_mean_std(
                    u_diff_array, window_size
                )
                feats.append(u_diff_std_array)
            if f"v_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                v_diff_mean_array, v_diff_std_array = rolling_mean_std(
                    v_diff_array, window_size
                )
                feats.append(v_diff_std_array)
            if f"ozone_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                ozone_diff_mean_array, ozone_diff_std_array = rolling_mean_std(
                    ozone_diff_array, window_size
                )
                feats.append(ozone_diff_std_array)
            if f"ch4_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                ch4_diff_mean_array, ch4_diff_std_array = rolling_mean_std(
                    ch4_diff_array, window_size
                )
                feats.append(ch4_diff_std_array)
            if f"n2o_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                n2o_diff_mean_array, n2o_diff_std_array = rolling_mean_std(
                    n2o_diff_array, window_size
                )
                feats.append(n2o_diff_std_array)
            if f"q2q3_mean_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                q2q3_mean_diff_mean_array, q2q3_mean_diff_std_array = rolling_mean_std(
                    q2q3_mean_diff_array, window_size
                )
                feats.append(q2q3_mean_diff_std_array)
            if f"uv_mean_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                uv_mean_diff_mean_array, uv_mean_diff_std_array = rolling_mean_std(
                    uv_mean_diff_array, window_size
                )
                feats.append(uv_mean_diff_std_array)
            if f"pbuf_mean_diff_std_{window_size}" in self.cfg.exp.seq_feats:
                pbuf_mean_diff_mean_array, pbuf_mean_diff_std_array = rolling_mean_std(
                    pbuf_mean_diff_array, window_size
                )
                feats.append(pbuf_mean_diff_std_array)
