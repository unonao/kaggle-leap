...
class LeapModel(nn.Module):
    def __init__(
        ...
        self.encoder = SqueezeformerEncoder(encoder_dim=previous_size, **encoder_params)
        ...
        self.header = nn.Sequential(
            *[
                nn.AdaptiveAvgPool2d((1, previous_size)),
                nn.Flatten(),
    ...
    def forward(self, x):
        ...
        # (batch, 60, 25+embedding_dim) -> (batch, 60, same_height_hidden_sizes[-1]*n_feat_channels)
