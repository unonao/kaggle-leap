...
class Scaler:
    ...
    def process_features(self, x_array):
        ...
        ch4_maxs = (x_array[:, 436:496] == 9.986058137126286e-07).astype(np.int8) + 4
        n2o_maxs = (x_array[:, 496:556] == 4.908583856935717e-7).astype(np.int8) + 6
        categorical_features = np.concatenate(
            [q2_zeros, q3_zeros, ch4_maxs, n2o_maxs], axis=1
        )
...
class LeapModel(nn.Module):
    def __init__(
        ...
        previous_size += 4 * categorical_embedding_dim
