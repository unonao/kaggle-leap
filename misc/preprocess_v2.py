...
print(
    f"{x_1_percentile.shape=}, {x_99_percentile.shape=}, {x_lower_bound.shape=}, {x_upper_bound.shape=}"
)
...
print(
    f"{y_1_percentile.shape=}, {y_99_percentile.shape=}, {y_lower_bound.shape=}, {y_upper_bound.shape=}"
)
